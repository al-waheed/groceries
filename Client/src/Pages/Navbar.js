            ...
            <div className="mx-auto max-w-auto px-2 sm:px-6 lg:px-16">
              <div className="relative flex h-[12vh] items-center justify-between">
                <div className="absolute inset-y-0 left-0 flex items-center md:hidden">
                  {/* Mobile menu button*/}
                  <Disclosure.Button className="relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-[#F54748] hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                ...
                {navigation.map((item) => (
                  <Disclosure.Button
                    ...
                    className={classNames(
                      item.current
                        ? "bg-[#F54748] text-white"
                        : "text-gray-300 hover:bg-[#F54748] hover:text-white",
