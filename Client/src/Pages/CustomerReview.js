...
import KeenSlider from "keen-slider"; // Import Keen Slider
...
export default function CustomerReview() {
  ...
  return (
    <section class="bg-[#F54748]">
      <div class="mx-auto max-w-[1340px] px-4 py-12 sm:px-6 lg:me-0 lg:py-16 lg:pe-0 lg:ps-8">
        <div class="max-w-7xl items-end justify-between sm:flex sm:pe-6 lg:pe-8">
          ...
          <div class="mt-8 flex gap-4 lg:mt-0">
            <button
              ...
              class="rounded-full border border-white p-3 text-white transition hover:bg-green-500 hover:text-white"
            >
              <svg
