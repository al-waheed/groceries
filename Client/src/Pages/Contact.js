...
import { TextStyle } from "../Util/Style";

const Contact = () => {
  return (
    <>
      <section className="mx-4 sm:mx-16 py-20 lg:py-[120px] overflow-hidden relative z-10">
        <div className="container">
          <div className="flex flex-wrap -ml-4 lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                <span className="block mb-4 text-base font-semibold text-[#2E2E2E]">
                  CONTACT US
                </span>
                <h2 className="mb-6 text-[32px] font-bold capitalize text-[#2E2E2E] sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                  Get In Touch With Us
                </h2>
                <TextStyle className="mb-9 ">
                  At <span className="text-[#F54748] font-bold">Grover</span>,
                  we are dedicated to providing top-quality services to our
                  customers. Our team of experts is here to assist you with any
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    <h4 className="mb-1 text-xl font-bold text-[#2E2E2E]">
                      Our Location
                    </h4>
                    <p className="text-base text-[#676767]">
                      99 S.t James Park, Oshodi 28292. Nigeria
                    </p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
              ...
              <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full p-3 text-white transition border rounded border-primary bg-[#F54748] hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
